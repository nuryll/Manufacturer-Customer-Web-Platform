					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
	<?php
$re=mysqli_query($con,"select * from products where productCompany like '$bul'");
...
if($num>0 and $nu>0 )
{
if ($ro=mysqli_fetch_array($re) == $row=mysqli_fetch_array($ret)) 
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id'],$ro['id']);?>"><img  src="assets/images/blank.gif" data-echo="seller/productimages/<?php echo htmlentities($row['id'],$ro['id']);?>/<?php echo htmlentities($row['productImage1'],$ro['productImage1']);?>" alt="" width="200" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="seller/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="200" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
