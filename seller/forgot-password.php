...
$query=mysqli_query($con,"SELECT * FROM cusers WHERE email='$email' and contactno='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="forgot-password.php";
mysqli_query($con,"update cusers set password='$password' WHERE email='$email' and contactno='$contact' ");
