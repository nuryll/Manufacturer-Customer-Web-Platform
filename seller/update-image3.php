...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"update  products set userId='".$_SESSION['id']."',productImage3='$productimage3' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage3 from products where id='$pid' and products.userId='".$_SESSION['id']."'");
$cnt=1;
