...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update cusers set name='$name',contactno='$contactno' where id='".$_SESSION['id']."'");
		if($query)
		{
...
{
$sql=mysqli_query($con,"SELECT password FROM  cusers where password='".md5($_POST['cpass'])."' && id='".$_SESSION['id']."'");
