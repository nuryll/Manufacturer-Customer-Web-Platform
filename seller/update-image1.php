...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  products set userId='".$_SESSION['id']."',productImage1='$productimage1' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage1 from products where id='$pid' and products.userId='".$_SESSION['id']."'");
$cnt=1;
