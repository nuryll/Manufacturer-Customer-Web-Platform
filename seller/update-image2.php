...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  products set userId='".$_SESSION['id']."',productImage2='$productimage2' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage2 from products where id='$pid' and products.userId='".$_SESSION['id']."'");
$cnt=1;
