...
$query=mysqli_query($con,"insert into cordertrackhistory(orderId,status,remark) values('$oid','$status','$remark')");
$sql=mysqli_query($con,"update corders set orderStatus='$status' where id='$oid'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = mysqli_query($con,"SELECT * FROM cordertrackhistory WHERE orderId='$oid'");
   ...
   <?php 
$st='Delivered';
   $rt = mysqli_query($con,"SELECT * FROM corders WHERE id='$oid'");
