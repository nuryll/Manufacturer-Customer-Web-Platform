...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=mysqli_query($con,"update csubcategory set categoryid='$category',subcategory='$subcat',updationDate='$currentTime' where id='$id'");
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select ccategory.id,ccategory.categoryName,csubcategory.subcategory from csubcategory join ccategory on ccategory.id=csubcategory.categoryid where csubcategory.id='$id'");
