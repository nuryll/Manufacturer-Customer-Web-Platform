...
$sql=mysqli_query($con,"update  cproducts set ccategory='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
$query=mysqli_query($con,"select cproducts.*,category.categoryName as catname,ccategory.id as cid,csubcategory.csubcategory as subcatname,csubcategory.id as subcatid from cproducts join ccategory on ccategory.id=cproducts.ccategory join csubcategory on csubcategory.id=cproducts.subCategory where cproducts.id='$pid'");
$cnt=1;
...
<?php $query=mysqli_query($con,"select * from ccategory");
