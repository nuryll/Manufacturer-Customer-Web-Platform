...
$sql=mysqli_query($con,"insert into ccategory(categoryName,categoryDescription) values('$category','$description')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from ccategory where id = '".$_GET['id']."'");
