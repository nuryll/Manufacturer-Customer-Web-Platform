...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=mysqli_query($con,"update ccategory set categoryName='$category',categoryDescription='$description',updationDate='$currentTime' where id='$id'");
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select * from ccategory where id='$id'");
