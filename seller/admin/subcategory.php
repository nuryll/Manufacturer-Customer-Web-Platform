...
$sql=mysqli_query($con,"insert into csubcategory(categoryid,subcategory) values('$category','$subcat')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from csubcategory where id = '".$_GET['id']."'");
...
<?php $query=mysqli_query($con,"select csubcategory.id,ccategory.categoryName,csubcategory.subcategory,csubcategory.creationDate,csubcategory.updationDate from csubcategory join ccategory on ccategory.id=csubcategory.categoryid");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>									
