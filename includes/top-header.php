...
<?php 
$sql="SELECT usersCredit FROM users where id='".$_SESSION['id']."'";
...
?>
				...
				<?php } ?>
                    ...
                    <li><a href="home.php"><i class="icon fa fa-home"></i>Home</a></li><i ></i>
...
<?php }
				...
				<li><a href="login.php"><i class="icon fa fa-sign-out"></i>Logout</a></li>
				<?php } ?>	
				</ul>
			</div><!-- /.cnt-account -->
